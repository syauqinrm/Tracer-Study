...
$id = $_SESSION["id"];
$profil_admin = query("SELECT * FROM akunadmin WHERE id = $id")[0];

if (isset($_POST["submit"])) {

    if (ubah_profil_admin($_POST) > 0) {
        echo "<script>  
            alert('Data Berhasil diubah');
            document.location.href = '../admin/profil_admin.php';
        </script>";
    } else {
        echo "<script>
...
<head>
    ...
    <title>Profil | Staff Admin</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div style="color: black; background-color: white;">
                        <h3 class="pl-4 pt-3">Profil <?= $user['username'] ?></h3>
                        <hr>
                        <form action="" method="POST">
                            <table class="ml-5">
                                <tr>
                                    <td><input type="hidden" name="id" value="<?= $profil_admin["id"]; ?>"></td>
                                </tr>
                                <tr>
                                    <td><label for="username">Username</label></td>
                                    <td>:</td>
                                    <td><input type="text" name="username" value="<?= $profil_admin['username'] ?>" required></td>
                                </tr>
                                <tr>
                                    <td><label for="password">Password</label></td>
                                    <td>:</td>
                                    <td><input type="text" name="password" value="<?= $profil_admin['password'] ?>" required></td>
                                </tr>
                                <br>
                                <tr>
                                    <td></td>
